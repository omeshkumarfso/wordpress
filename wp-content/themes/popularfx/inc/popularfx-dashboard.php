...
<div class="wrap" style="margin-top:0px;">
	...
	<table cellpadding="2" cellspacing="1" width="100%" class="fixed" border="0">
		<tr>
			...
			<td align="right" width="40"><a target="_blank" href="'.esc_url('https://twitter.com/PopularFXthemes').'"><img src="'.POPULARFX_URL.'/images/twitter.png" /></a></td>
			<td align="right" width="40"><a target="_blank" href="'.esc_url('https://facebook.com/PopularFX').'"><img src="'.POPULARFX_URL.'/images/facebook.png" /></a></td>
		</tr>
	</table>
	<hr />
	...
	if($promos){
		...
		<div class="postbox" style="min-width:0px !important;">
			...
			<div class="inside">
				...
				<center><a class="button button-primary" target="_blank" href="'.POPULARFX_PAGELAYER_PRO_URL.'">'.__('Upgrade', 'popularfx').'</a></center>
			</div>
		</div>';
		...
		echo '
			<div class="postbox" style="min-width:0px !important;">
				...
				<div class="inside">
					...
					<center><a class="button button-primary" target="_blank" href="https://wpcentral.co/?from=pfx-theme-'.popularfx_get_current_theme_slug().'">'.__('Visit wpCentral', 'popularfx').'</a></center>
				</div>
			</div>
	...
	<div class="postbox">
		...
		<?php
			...
			<tr>
				...
				<td align="left">
					<a href="'.esc_url(POPULARFX_WWW_URL).'/templates">'.(defined('PFX_VERSION') ? PFX_VERSION : __('Install PopularFX Website Templates Plugin', 'popularfx')).'</a>
				</td>
			</tr>
